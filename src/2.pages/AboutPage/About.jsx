      ...
      <div className="about-container">
        <div className="hero-card background-color-components">
          <div className="hero-card-item">
            ...
            <p className="hero-item-p">
              Adopting a pet is more than just bringing a furry friend home; it
              is a compassionate act that benefits both you and the animal. By
              adopting, you are saving lives, gaining a loving companion, making
              a positive environmental impact, experiencing personal growth, and
        ...
        <div className="details-card background-color-components">
          ...
          <div className="details-card-item">
            ...
            <p>
              We believe in the power of hope. We offer hope to animals in need
              by providing them with a second chance at life, and we offer hope
              to people seeking a loving companion.
            </p>
          </div>
          <div className="details-card-item">
            <h2 className="card-item-title">Ownership</h2>
            <p>
              We are committed to responsible pet ownership. We provide
              education and resources to help adopters understand the
              responsibilities of caring for a pet, and we encourage responsible
              breeding practices.
            </p>
          </div>
        </div>
